...
## Question 1
***
How many hate crimes are taking place in NY state? Who are the people most affected? The stacked bar chart below provides us a clear initial view.
...
q1 <- data%>%filter(Type== 'Anti.Age') %>%
  ...
  annotate('text',x= -74,y=40.71, label='NY', color= 'red',hjust=1)+
...
We also annotate the location of New York city with text 'NY' on six plots. We can see that New York city is located in the southeast corner of New York state, a place we have to pay attention to. That is, for us Columbia students, we should be careful with these possible dangerous situations.
