...
There are many international metropolises around the world, like London, Tokyo and Shanghai. Among those famous cities, New York is the most remarkable one. For example, it's probably the only city where you can live with any languages other than English. However, there are still a number of people from different races, genders, religions etc. backgrounds still suffer from biases and discrimination. Hate Crime, or bias-motivated crime, is one of the most dangerous consequences. 
